...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Des 2018 pada 02.16
...
(5, 'giginaga', '7d52a9edf73392ba88e65d58aebbce8a', 'giginaga@gmail.com', 'Gigi Naga', 'GigiNaga', '0000-00-00', '', 'giginaga.png');
...
--
ALTER TABLE `comic`
  MODIFY `comic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `comic_chapter`
--
ALTER TABLE `comic_chapter`
  MODIFY `chapter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `novel`
--
ALTER TABLE `novel`
  MODIFY `novel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `comic_chapter`
  ADD CONSTRAINT `comic_rel` FOREIGN KEY (`comic_id`) REFERENCES `comic` (`comic_id`);
...
--
ALTER TABLE `novel_chapter`
  ADD CONSTRAINT `novel_rel` FOREIGN KEY (`novel_id`) REFERENCES `novel` (`novel_id`);
COMMIT;
