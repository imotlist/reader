        ...
        <section id="main-streams">
            <section id="episodes-section">
                ...
                <div id="episodes" class="clearfix ">
                    <center>
                        <img src="<?=base_url('assets').'/img/creator/'.$comic->author_username.'/comic/'.$comic->comic_cover?>" width="500" height="500" alt="Home">
                    </center>
                </div>
                            ...
                            <div class="tc">                              
                                ...
                                <div class="series-info-wrap" id="series-info-wrap">
                                    <header class="series-header">
                                        ...
                                        <h1 class="title">
                                        <a class="series-header-title" href="#"><?= $comic->comic_judul ?></a>
                                          <?php if(!empty($auth)): ?>  
                                            <a class="series-edit-btn" href="<?=base_url('series/editcomic/'.$comic->comic_id)?>" data-toggle="tooltip" data-title="Edit" data-placement="right"><i class="sp-ico-edit-on"></i></a>
                                          <?php endif ?>
                                    </h1>
                                        <div class="extra-header-info">
                                            ...
                                            <div class="author">
                                                <a href="#" class="thumb">
                                                    <img src="<?=base_url('assets/img/profile/'.$comic->author_profile)?>" width="40" height="40" alt="imotlist" class="circle">
                                                </a>
                                                <span itemscope="" itemprop="author" itemtype="http://schema.org/Person">
                                            <a href="<?=base_url('author/'.$comic->author_username)?>" class="name" title="imotlist" rel="author" itemprop="url"><span itemprop="name"><?=$comic->author_nickname?></span></a>
                                                </span>
                                            </div>
                                            ...
                                            <ul class="number-status">
                                                <li class="common-tooltip" data-title="0 views" data-placement="right" data-original-title="" title="">
                                                    ...
                                                    <span class="cnt-txt"><?=$comic->comic_genre?></span>
                                                </li>
                                            ...
                                            <div class="viewport fh">
                                                <ul id="episode-list" class="overview" style="top: 0px;">
                                                    <?php foreach($series as $s): ?>
                                                        <li class="episode">
                                                            <a class="cp episode-box comics" href="#" name="<?=$s->chapter_id?>">
                                                                <div class="episode-thumb-wrap">
                                                                    <div class="thumb-filter  " data-title="Chapter 1" data-placement="right" data-original-title="" title="">
                                                                        <i class=""></i>
                                                                    </div>
                                                                    <img class="ep-thumb-img" src="<?=base_url('assets').'/img/creator/'.$comic->author_username.'/comic/'.$comic->comic_cover?>" data-uid="1263616" data-load="false" width="50" height="50" alt="Chapter 1">
                                                            ...
                                                            <?php if(!empty($auth)): ?>  
                                                             <a class="ep-edit-btn" href="<?=base_url('series/editcomicEpisode/'.$s->chapter_id)?>" data-toggle="tooltip" data-title="Edit" data-placement="bottom" data-original-title="" title=""><i class="sp-ico-edit-on"></i></a>
                                                            <?php endif ?>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".cp").click(function(){
            ...
            $.ajax({
                    type:"POST",
                    url: "<?= base_url('series/getComicSeries') ?>",
                    cache: false,
                    data:{id:key},
