		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-10">
							<form method="post" enctype="multipart/form-data" action="<?= base_url('mcomic/update') ?>">
								<input type="hidden" name="id" value="<?=$d->comic_id?>">
								<div class="form-group">
									<label class="control-label">Judul</label>
									<div class="clearfix">
										<input type="text" name="judul" class="form-control" required value="<?=$d->comic_judul?>">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label">Deskripsi</label>
									<div class="clearfix">
										<textarea class="form-control" rows="7" name="desc" required><?=$d->comic_desc?></textarea>
									</div>
								</div>		
								<div class="form-group">
