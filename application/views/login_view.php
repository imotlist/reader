...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?=base_url()?>temp_admin/assets/css/ace.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="../assets/css/ace-part2.css" />
		<![endif]-->
		<link rel="stylesheet" href="<?=base_url()?>temp_admin/assets/css/ace-rtl.css" />
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<span class="red">Handal</span>
									<span class="white" id="id-text2">Media</span>
								</h1>
								<h4 class="blue" id="id-company-text">Inventory Barang</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="POST" action="<?= base_url('backdoor/getlogin')?>">
												<fieldset>
